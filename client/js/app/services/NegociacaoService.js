...
System.register(['./HttpService', './ConnectionFactory', '../dao/NegociacaoDao', '../models/Negociacao'], function (_export, _context) {
    ...
    var HttpService, ConnectionFactory, NegocicaoDao, Negociacao, _createClass, NegociacaoService;
    ...
    return {
        setters: [function (_HttpService) {
            ...
            NegocicaoDao = _daoNegociacaoDao.NegocicaoDao;
                ...
                _createClass(NegociacaoService, [{
                    ...
                    value: function cadastra(negociacao) {
                        ...
                        return ConnectionFactory.getConnection().then(function (connection) {
                            return new NegocicaoDao(connection);
                        }).then(function (dao) {
