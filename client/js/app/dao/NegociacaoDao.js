...
System.register(['../models/Negociacao'], function (_export, _context) {
    ...
    var Negociacao, _createClass, NegocicaoDao;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('NegocicaoDao', NegocicaoDao = function () {
                function NegocicaoDao(connection) {
                    _classCallCheck(this, NegocicaoDao);

                    this._connection = connection;
                    this._store = 'negociacoes';
                }

                _createClass(NegocicaoDao, [{
                    key: 'adiciona',
            ...
            _export('NegocicaoDao', NegocicaoDao);
        }
    };
});
